...
// Listeners
export default function lsiteners (state = {}, action) {
	switch (action.type) {
		case ADD_LISTENER:
			return {
				...state,
...
function userDuck (state = initialUserDuckState, action) {
	switch (action.type) {
...
function duckReplies (state = intiialReplyState, action) {
	switch (action.type) {
		case ADD_REPLY:
			return {
				...state,
...
const intiialDuckState = {
	lastUpdated: Date.now(),
	replies: {},
}

function repliesAndLastUpdated (state = intiialDuckState, action) {
	switch (action.type) {
